...
@property (nonatomic, readonly,strong) UIButton *m_btnBack;
@property (nonatomic, readonly,strong) UILabel *m_labelTitle;
@property (nonatomic, readonly,strong) UIImageView *m_imgViewBg;
@property (nonatomic, readonly,strong) UIButton *m_btnLeft;
@property (nonatomic, readonly,strong) UIButton *m_btnRight;
...
{
    if (isPad_SC) {
        return Rect(112.0f, 22.0f, 800.0f, 40.0f);
    }
...
- (void)setRightBtn:(UIButton *)btn
{
    ...
    if (_btnRight)
    {
        _btnRight.frame = Rect(320 - RectWidth(btn.frame), 27.0, RectWidth(btn.frame), RectHeight(btn.frame));
        if (isPad_SC) {
            _btnRight.frame = Rect(1024 - RectWidth(btn.frame), 27.0, RectWidth(btn.frame), RectHeight(btn.frame));
        }
